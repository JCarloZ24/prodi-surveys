...
export function emailDefs(): EmailDef[] {
  return [
    ...
    },
    {
      ...
      from: "Prodi-Surveys <no-reply@prodigitality.net>",
      to: "respondent",
      preheader: "Your survey response has been verified.",
      accent: "#15803D",
      vars: { firstName: "Maria" },
      blocks: [
        { type: "h", text: "Your response has been verified 🎉" },
        { type: "p", text: "Thank you, {{firstName}}. Our QA team has reviewed and verified your submission. Your participation in the Prodigitality baseline survey is complete." },
