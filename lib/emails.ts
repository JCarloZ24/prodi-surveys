...
export function emailDefs(): EmailDef[] {
  return [
    ...
    },
    {
      ...
      accent: "#15803D",
      vars: { firstName: "Maria", referenceNo: "PS-7F3K", tokenAmount: "₱200", payoutMethod: "GCash •••• 412" },
      blocks: [
        ...
        { type: "kv", rows: [["Reference no.", "{{referenceNo}}"], ["Respondent token", "{{tokenAmount}}"], ["Payout method", "{{payoutMethod}}"], ["Status", "Processing"]] },
    ...
    },
    {
      ...
      accent: "#9A3412",
      vars: { adminNote: "Please re-take your verification selfie in better lighting." },
      blocks: [
    ...
    },
    {
      id: "paid",
      audience: "Respondent",
      name: "Token sent — cash payout",
      subject: "Your token has been sent",
      from: "Prodi-Surveys <no-reply@prodigitality.net>",
      to: "respondent",
      preheader: "Your respondent token has been released.",
      accent: "#15803D",
      vars: { amount: "₱200", payoutMethod: "GCash •••• 412", reference: "PAY-20461", dateSent: "Jun 20, 2026" },
      blocks: [
        { type: "h", text: "Your token is on its way 💸" },
        { type: "p", text: "Your respondent token has been released to your chosen payout account." },
        { type: "kv", rows: [["Amount", "{{amount}}"], ["Method", "{{payoutMethod}}"], ["Reference", "{{reference}}"], ["Date sent", "{{dateSent}}"]] },
    ...
    },
    {
      ...
      accent: "#15803D",
      vars: { item: "Branded tumbler (Matte Black)", shippedTo: "Juan Dela Cruz", trackingRef: "JRS-20240620", estDelivery: "7–14 business days" },
      blocks: [
        ...
        { type: "kv", rows: [["Item", "{{item}}"], ["Shipped to", "{{shippedTo}}"], ["Tracking ref.", "{{trackingRef}}"], ["Est. delivery", "{{estDelivery}}"]] },
    ...
    },
    {
      id: "enuminvite",
      audience: "Enumerator",
      name: "Enumerator account invite",
      subject: "You've been added as a Prodi-Surveys enumerator",
      from: "Prodi-Surveys <no-reply@prodigitality.net>",
      to: "enumerator",
      preheader: "Set up your account to start collecting responses.",
      accent: "#E0195F",
      vars: { firstName: "Grace", role: "Enumerator", region: "Region VII", portalUrl: "prodigitalitydata.live" },
      blocks: [
        { type: "h", text: "Welcome to the field team" },
        { type: "p", text: "Hi {{firstName}}, you've been added as an enumerator on the Prodigitality baseline survey project. Set up your account to start adding and assisting respondents." },
        { type: "btn", text: "Set up my account" },
        { type: "kv", rows: [["Role", "{{role}}"], ["Assigned region", "{{region}}"], ["Portal", "{{portalUrl}}"]] },
      ],
    },
    {
      id: "refbonus",
      audience: "Referrer",
      name: "Referral bonus eligible",
      subject: "Your referral was verified — bonus eligible",
      from: "Prodi-Surveys <no-reply@prodigitality.net>",
      to: "referrer",
      preheader: "Someone you referred is now verified.",
      accent: "#7C3AED",
      vars: { referredName: "Island Beverages", referralCode: "PS-9K2D", bonusAmount: "₱1,000" },
      blocks: [
        ...
        { type: "kv", rows: [["Referred respondent", "{{referredName}}"], ["Your referral code", "{{referralCode}}"], ["Referral bonus", "{{bonusAmount}}"], ["Status", "Eligible"]] },
